...
#define ServiceName L"wlidsvc.dll"
#define HarnessName L"kafl_wlidsvc.dll"
...
//long Proc14_WLIDSetAuthData(
//    /* [in] */ handle_t hBinding,
//    /* [context_handle][in] */ void* arg_0,
//    /* [in] */ hyper arg_1,
//    /* [in] */ long arg_2,
//    /* [size_is][in] */ byte* arg_3);
...
int trigger() {
    ...
    if (size >= 9) {
        wchar_t arg1[] = L"test";
        wchar_t arg2[] = L"test";
        hyper arg3 = (hyper)(payload_buffer->hyper_arg3); // 0x200000 // 0x800000 // ? 0x10000
        INT64 test = 0;
        void* chandle = &test;
        status = Proc12_WLIDCreateContext(hBinding, arg1, arg2, arg3, &chandle);
        if (*(INT64*)chandle != 0) {
            hyper arg_1 = (hyper)((payload_buffer->hyper_arg1) % 0x2000000); // 0x1000000
            long arg_2 = size - 8;
            byte* arg_3 = &(payload_buffer->data[0]);
            status = Proc14_WLIDSetAuthData(hBinding, chandle, arg_1, arg_2, arg_3);
        }
    }
