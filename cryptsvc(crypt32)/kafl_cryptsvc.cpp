...
#define TargetDLL1 L"cryptsvc.dll"
#define TargetDLL2 L"crypt32.dll"
#define HarnessDLL L"kafl_cryptsvc.dll"
...
void submit_ip_ranges() {
    HMODULE hModule;
    byte idx = 0;
    hModule = GetModuleHandleW(TargetDLL1);
    ...
    idx++;
    hModule = GetModuleHandleW(TargetDLL2);
    hprintf("[Harness][submit_ip_ranges] Call set_ip_range - %ws\n", TargetDLL2);
    if (!set_ip_range(hModule, idx)) {
        hprintf("[Harness][submit_ip_ranges] Failed set_ip_range - %ws\n", TargetDLL2);
        return;
...
int trigger() {
    ...
    long size = payload_buffer->size;
    if (size >= 5) {
        long arg1 = ((payload_buffer->arg1) % 15) + 1;
        long arg2 = 4;
        wchar_t* arg3 = SysAllocString(L"TEST");
        byte* arg4 = &(payload_buffer->arg4[0]);
        long arg5 = size - 4;
        byte* arg6 = NULL;
        long arg7 = 0;

        Proc0_s_SSCertProtectFunction(hBinding, arg1, arg2, arg3, arg4, arg5, &arg6, &arg7);
    }
