...
#define ServiceName L"webauthn.dll"
#define HarnessName L"kafl_webauthn.dll"
...
int trigger() {
    ...
    if (size >= 5) {
        long arg3 = size - 4;
        long arg5 = (payload_buffer->arg5) % 8000;;
        byte* arg2 = &(payload_buffer->data[0]);
        byte* arg4 = (byte*)malloc(arg5 * sizeof(byte));

        Proc0_s_SSCtapCommand(hBinding, arg2, arg3, &arg4, &arg5);
