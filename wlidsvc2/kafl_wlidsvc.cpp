...
LONG CALLBACK exc_handle(struct _EXCEPTION_POINTERS* ExceptionInfo)
{
    ...
    hprintf("Exception caught: 0x%lx\n", exception_code);
    ...
    if ((exception_code == EXCEPTION_ACCESS_VIOLATION) ||
        ...
        (exception_code == 0x57) ||
        (exception_code == 0x6f5) ||
        (exception_code == 0x6f7) ||
        (exception_code == 0x6c6) ||
        (exception_code == 0x6c2) ||
...
int trigger() {
    ...
    if (size >= 4) {
        long arg1 = 3;
        Struct_740_t* arg2 = (Struct_740_t*)malloc(arg1 * sizeof(Struct_740_t));
        arg2->StructMember0 = size;
        arg2->StructMember1 = size;
        arg2->StructMember2 = &(payload_buffer->data[0]);
        hyper arg3 = 0;

        status = Proc27_WLIDSetOptions(hBinding, arg1, arg2, arg3);
