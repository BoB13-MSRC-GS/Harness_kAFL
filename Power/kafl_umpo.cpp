...
#define ServiceName L"umpo.dll"
#define HarnessName L"kafl_umpo.dll"
...
int trigger() {
    ...
    if (size >= 4) {
        ...
        Struct_30_t* guid = new Struct_30_t;
        guid->StructMember0 = 0x11111111;
        guid->StructMember1 = 0x1111;
        guid->StructMember2 = 0x1111;
        guid->StructMember3[0] = 0x11;
        guid->StructMember3[1] = 0x11;
        guid->StructMember3[2] = 0x11;
        guid->StructMember3[3] = 0x11;
        guid->StructMember3[4] = 0x11;
        guid->StructMember3[5] = 0x11;
        guid->StructMember3[6] = 0x11;
        guid->StructMember3[7] = 0x11;

        long arg4 = *(long*)data;
        unsigned char* arg3 = (unsigned char*)malloc(arg4 * sizeof(unsigned char));
        memset(arg3, 0, arg4);
        long* arg5 = (long*)malloc(0x128 * sizeof(long));

        status = Proc30_UmpoRpcReadSecurityDescriptor(hBinding, arg1, guid, arg3, arg4, arg5);
