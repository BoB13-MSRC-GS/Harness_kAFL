...
#define ServiceName L"mispace.dll"
#define HarnessName L"kafl_mispace.dll"
...
RPC_BINDING_HANDLE GetBindingHandle(void)
{
    ...
    status = RpcStringBindingComposeW(
        ...
        (RPC_WSTR)L"ncalrpc",
        NULL,
        (RPC_WSTR)L"microsoft_windows_wsp_spaces",
        NULL,
        &stringBinding
    );
...
int trigger() {
    ...
    if (size >= 5) {
        //hprintf("in\n");
        //hprintf("payload_buffer->arg4 : %d\n", payload_buffer->arg4);
        long arg2 = size - 4;
        byte* arg1 = &(payload_buffer->data[0]);
        long arg4 = (payload_buffer->arg4) % 0x1000000;
        byte* arg3 = (byte*)malloc(arg4 * sizeof(byte));
        long* arg5 = &arg4;
        //if (arg3 == NULL) {
        //    hprintf("arg3 is null ptr!!\n");
        //}
        status = Proc0_ClusterSpaceControl(hBinding, arg1, arg2, arg3, arg4, arg5);
        free(arg3);
    }
