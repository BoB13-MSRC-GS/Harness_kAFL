...
#include <dbghelp.h>
#include <psapi.h>
#include "psmserviceexthost.h"

#define ServiceName L"psmserviceexthost.dll"
#define HarnessName L"kafl_psmserviceexthost.dll"
...
int trigger() {
    ...
    if (size >= 1) {
        ...
        status = Proc23_HamRpcSrvPlmNotifyNewSession(hBinding, arg1, arg2);
    }
